    ...
    <header class="main-header-top hidden-print">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <ul class="top-nav lft-nav">
                ...
                <li>
                    <a href="http://localhost/Module2/Case/public/?url=SimController/searchSimLocPhat"  role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"><span>Sim Phat Loc</span>
                    </a>
                </li>
                <li>
                    <a href="http://localhost/Module2/Case/public/?url=SimController/addSimTest"  role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"><span>Them Sim Moi</span>
                    </a>
                </li>
                <li class="dropdown">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-header-text">Quan ly SIM</h5>
                            ...
                            <table class="table">
                                ...
                                <?php foreach($sim as $key=>$sim): ?>
                                    <tr class="table-active">
                                        ...
                                        <td>
                                            <a href="http://localhost/Module2/Case/public/?url=SimController/addSimTest">
