    ...
    <header class="main-header-top hidden-print">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <ul class="top-nav lft-nav">
                <li>
                    <a href="http://localhost/Module2/Case/public/?url=SimController/searchSimTuQuy"  role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"><span> Sim Tu Quy</span>
                    </a>
                </li>
                <li>
                    <a href="http://localhost/Module2/Case/public/?url=SimController/searchSimLocPhat"  role="button"  aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"><span>Sim Phat Loc</span>
                    </a>
                </li>
                <li>
                    <a href="http://localhost/Module2/Case/public/?url=SimController/addSimTest"  role="button"  aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"><span>Them Sim Moi</span>
                    </a>
                </li>
                <li class="dropdown">
            ...
            <div class="navbar-custom-menu f-right">
                <form method="post" action="http://localhost/Module2/Case/public/?url=SimController/searchSim">
                    <table>
                        <tr>
                            <th>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="review-content-section">
                                                                    <div class="input-group mg-b-pro-edt">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Số Thuê Bao" name = "PhoneNumber" >
                                                                    </div>
                                                                    <div class="input-group mg-b-pro-edt">
                                                                        <span class="input-group-addon"></span>
                                                                        <input type="text" class="form-control" placeholder="Loại Sim" name= "Type">
                                                                    </div>
                                                                    <select name="Center" class="form-control pro-edt-select form-control-primary">
                                                                        <option>Cơ sở</option>
                                                                        <option name="Center">Hà Nội</option>
                                                                        <option name="Center">Hải Phòng</option>
                                                                        <option name="Center">TP HCM</option>
                                                                    </select>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="review-content-section">
                                                                    <div class="input-group mg-b-pro-edt">
                                                                        <span class="input-group-addon"></span>
                                                                        <input type="text" class="form-control" placeholder="Giá Sim" name="Price" >
                                                                    </div>
                                                                    <select name="Network" class="form-control pro-edt-select form-control-primary">
                                                                        <option name="Network">Mạng Di Động</option>
                                                                        <option name="Network">Viettel</option>
                                                                        <option name="Network">Mobiphone</option>
                                                                        <option name="Network">Vinaphone</option>
                                                                        <option name="Network">Vietnammobile</option>
                                                                    </select>
