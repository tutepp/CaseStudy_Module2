    ...
    <header class="main-header-top hidden-print">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <ul class="top-nav lft-nav">
                <li>
                    <a href="http://localhost/Module2/Case/public/?url=SimController/searchSimTuQuy" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"><span> Sim Tu Quy</span>
                    </a>
                </li>
                <li>
                    <a href="http://localhost/Module2/Case/public/?url=SimController/searchSimLocPhat" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image"><span>Sim Phat Loc</span>
                    </a>
                </li>
                <li class="dropdown">
                    <a href="http://localhost/Module2/Case/public/?url=SimController/addSimTest" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                            ...
                            <table class="table">
                                ...
                                <tr class="table-active">
                                    ...
                                    <td>
                                        ...
                                        <a href="# ?>" onclick= "return confirm('Bạn chắc chắn muốn xoá?')">
